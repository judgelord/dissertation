...
- A **public pressure campaign** is an effort to influence policy by mobilizing a segment of the public to pay attention to the policy process and express their opinions to decisionmakers. It can be an astroturf campaign or grassroots campaign on behalf of public or private interests. Empirically, I focus on public pressure campaigns in public comment periods, often called a "mass commenting campaign." Comments mobilized by such campaigns are typically form letters and are often called "mass comments." For analytic purposes, I define a mass comment in \@ref(why-methods) as any comment sharing a substantial amount of text with 99 other comments or uploaded in a batch of 100 or more by the same organization.
