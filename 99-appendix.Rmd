...
As discussed in Chapter \@ref(whymail), the number of agency rules receiving large number of public comments has increased over time. Figure \@ref(fig:comments-per-year-app) breaks out the data presented in Figure \@ref(fig:comments-per-year-app) by year. Red numbers show the number of comments received by on the proposed rule with the most comments (the one furthest to the right) for each year. For refrence, 10 comments is also marked, showing that in every year from 2005 to 2020, the majority of proposed rules open for comment on regulations.gov recieved less than 10 comments. 
