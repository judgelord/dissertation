...
Unsurprisingly a OLS model predicting lobbying success as a combination of coalition size, a business coalition, comment length, and mass comments yields no significant results. With lobbying success as the dependent variable, the coefficient on the main variable of interest would be interpreted as a one-unit increase in the logged number of comments corresponds to a $\beta_{logmasscomments}$ increase in the five-point influence scale.
