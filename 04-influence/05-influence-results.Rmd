...
To test Hypothesis \@ref(hyp:oversight), I calculate the simple correlation between the number of comments from members of Congress and all other comments on each rule. I also calculate this correlation, ommitting rules where no legislators commented, making it more plausable that legislators were aware of the rulemaking and thus faced the choice of whether to comment or not. Figure \@ref(fig:congress-corr) shows both of these correlations. The dashed line showes the relationship for all rules and the solid line shows the relationship for rules where at least one legislator commented. The left-hand pannel shows this same plot with both axes on a log scale. There is a strong correlation between mass comments and legislator attention. However, for resons disccussed in \@ref(oversight-hypotheses), this is not strong evidence of a causal effect. 
