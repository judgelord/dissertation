...
```{r model-success, eval=FALSE, cache=FALSE}
...
```{r model-success-plot, cache=FALSE, eval=FALSE,  fig.width=6, fig.height=2, out.width = "100%", fig.cap= "OLS model of coalition lobbying sucess with hand-coded data"}
m %>%
  tidy(conf.int = TRUE) %>% 
...
```{r mediation, cache=FALSE, eval=FALSE}
library(mediation)
