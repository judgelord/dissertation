...
**Explanatory variables:** *Coalition size* (a count) is the number of organizations lobbying together on the rule. *Business colation* is binomial. *Comments* is the total number of comments (including mass comments) mobilized by members of the coalition, which I transform to a log scale for modeling. 
