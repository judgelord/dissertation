...
```{r mcfe-success-quadratic-predicted, fig.height=3, fig.width=4.5, fig.cap="Coalition Lobbying Success"}
...
```{r mcfe-success-pro, fig.height=3, fig.width=4.5, fig.cap="Coalitions Supporting Proposed Rule"}
#mc-success-pro
...
```{r mcfe-success-con, fig.height=3, fig.width=4.5, fig.cap="Coalitions Opposing Proposed Rule"}
#mc-success-con
...
modelsummary::modelsummary( modelsFE, 
                          ...
                          add_rows = rowsFE, 
                          title = "OLS Models of Coalition-Level Lobbying Success",
                          notes = "") %>% kable2(file = "mc-success-congress")
...
modelsummary::modelsummary( modelsFE, 
                          ...
                          add_rows = rowsFE, 
                          title = "OLS Models of Coalition-Level Lobbying Success",
                          notes = "") %>% kable2(file = "mc-presidentXagency")
...
```{r mcfe-success-president, fig.height=3, fig.width=4.5, fig.cap="By president"}
...
modelsummary::modelsummary( models_president, 
                            ...
                            coef_rename =  cm,
                            gof_omit = "R2 .*",
                            title = "OLS Models of Coalition-Level Lobbying Success with Indicators for President",
                          add_rows = rowsFE, 
                          notes = "") %>% 
  row_spec(row = 1, bold = T) %>% kable2(file = "mc-success-president")
...
### Two-way interaction 
```{r mcfe-success-president2, fig.height=3, fig.width=4.5, fig.cap= "President-coalition type interaction model"}
...
modelsummary::modelsummary( models_president, 
                            ...
                            coef_rename =  cm,
                            gof_omit = "R2 .*",
                            title = "OLS Models of Coalition-Level Lobbying Success with Interactions for President",
                          add_rows = rowsFE, 
                          notes = "") %>% 
  row_spec(row = 1, bold = T) %>% kable2(file = "mc-success-president2")
...
modelsummary::modelsummary( models_president, 
                            ...
                            coef_rename =  cm,
                            gof_omit = "R2 .*",
                            title = "OLS Models of Coalition-Level Lobbying Success with Interactions for President and Coalition Type",
                          add_rows = rowsFE, #FIXME rename rowsFE lobbying success
                          notes = "") %>% 
  row_spec(row = 1, bold = T) %>% kable2(file = "mc-success-president3")
...
```{r tree, fig.height=10, fig.cap="Coalitions that used a Public Pressure Campaign  by President, Agency, and Docket"}
library(plotrix)


sizetree(coalitions_coded %>% filter(campaign_) %>% select(president, agency, docket_id, coalition), base.cex	
 = .60)
```
...
# INTERCEPT ONLY MODELS TO ASSESS INTRA CLASS VARIANCE 
mcme1 = lmer(coalition_success ~ 
              (1|agency) + (1|president), # random intercept for each agency and president 
               data = mc_data)
# intra-class correlation - how much two much varience at agency level = agency variance / total 
# cuttoff is above .05 
# design effect 
...
modelsummary::modelsummary( models_mcme, 
                            ...
                            coef_omit = "sd__.Int",
                            gof_omit = "R2 .*",
                            title = "OLS Models of Coalition-Level Lobbying Success with Random Intercepts",
                          add_rows = success_rows6, 
                          notes = "") %>% 
  row_spec(row = 1, bold = T) #%>% kable2(file = "mcme")
...
modelsummary::modelsummary( models_mcme, 
                            ...
                            coef_omit = "sd__.Int",
                            gof_omit = "R2 .*",
                            title = "OLS Models of Coalition-Level Lobbying Success with Random Slopes by President and Agency",
                          add_rows = success_rows6, 
                          notes = "") %>% 
  row_spec(row = 1, bold = T) %>% kable2(file = "mcme-hierarchical")
...
# crossed effects intercept only model (lmer figures out the relationship between groups)
mome1 = lmer(success ~ (1|coalition) + (1|agency) + (1|docket_id) +
             # (1|agency/coalition) + 
               (1|president), # random intercept for each agency and president 
               data = mo_data)
# design effect over 1000 at coalition. square root is 36
...
modelsummary::modelsummary( models_mome, 
                            ...
                            coef_omit = "sd__.Int",
                            gof_omit = "R2 .*",
                            title = "OLS Models of Organzation-Level Lobbying Success with Random Intercepts for President and Agency",
                          add_rows = success_rows3, 
                          notes = "") %>% 
  row_spec(row = 1, bold = T) %>% kable2(file = "mome")
...
```{r mome, fig.height=3, fig.width=5.5, fig.cap= "Organization-level Predicted Lobbying Success for Selected Organzations"}
