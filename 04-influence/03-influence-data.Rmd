...
comments_coded %>% ungroup() %>% 
  ...
  ungroup() %>% 
  arrange(coalition) %>% 
  kable3(caption = "A Sample of Organzation-Level Hand-Coded Public Comment Data")
```
...
Other predictors of lobbying success in the models below include <!-- the length of the (lead) organization's comment,--> whether the coalition is lobbying unopposed, the size of the lobbying coalition, and whether the coalition is majority businesses and trade associations. 
<!--
