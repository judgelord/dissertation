...
Following this introduction, Section \@ref(influence-theory) reviews past work and builds a theory of how public pressure may affect policy outcomes. Section \@ref(influence-data) introduces a novel dataset developed through an iterative process of computational methods and hand-coding. Section \@ref(influence-methods) develops models that use these data to assess the relationship between public pressure, both directly and indirectly, through mobilizing elected officials. Section \@ref(influence-results) presents the results and Section \@ref(influence-conclusion) concludes the chapter. 
