...
Hypothesis \@ref(hyp:hc-success) sets out the most direct implication of my theory. If public pressure campaigns generate political information that affects policy, lobbying coalitions that use pressure campaigns should more win more often.

```{hypothesis hc-success, echo = TRUE}
Lobbying coalitions are more likely to succeed when they use public pressure campaigns.
```
...
On average, public pressure campaigns are more highly correlated with success for private interests than public interest groups. 
```
...
Organizations are more likely to succeed when they lobbying in a coalition backed by a public pressure campaign.
```
...
The remainder of this section focuses on one key element of an agency's stratigic environment: attention from members of Congress. 
