...
One reason that scholars have ignored public pressure campaigns targeting the bureaucracy is the strong normative belief among legal scholars that bureaucratic policymaking should rest on rational analysis rather than politics.
...
Figure \@ref(fig:causal-whymail2) amends what I call the ``classic model" of interest
...
information. For simplicity, \@ref(fig:causal-whymail2) focuses on one possible mechanism, the effect that public pressure campaigns may have on policymakers' perceptions of public opinion (or at least opinion among certain segments of the public). I address other types of political information that mass engagement may create below (see Figures \@ref(fig:causal-oversight)).<!-- and
    \@ref(fig:causal-full)). -->
