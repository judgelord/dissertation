...
I trained a team of undergraduate research assistants to apply the codebook to a random sample of 100 rules with mass comment campaigns and 100 rules without a mass comment campaign, most of which had a draft and final rule. Several rules were double-coded by the shole team. Intercoder reliability was XX. I also double-coded all comments that were part of mass comment campaigns with more than XX comments.
