...
Using new measures of the political information that lobbying coalitions create by going public (step 1), I assess the effect of mass mobilization on elected officials' attention (step 2) and on agency responses and policy outcomes (step 3).% But first, I must develop a measure of ``going public.'' % and why it occurs.
