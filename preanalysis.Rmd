...
coalition_success <- sample(x = c(-1, -.5, 0, .5, 1), 1000, replace = T, prob = c(0.1, 0.3, .1, 0.4, 0.1))

coalition_size <- rtnorm(1000, mean = 5, sd= 10, lower = 1) %>% round()

coalition_business <- sample(x = c(0,1), 1000, replace = T, prob = c(0.5, .5))
...
ggplot(d, aes( x= comment_length)) + geom_histogram()+ labs(x = "Comment length/proposed rule length")
