...
## If groups build the power required to pass a Green New Deal, what happens when agencies write the actual policies? 

--

## Do we expect organized pubic pressure to carry over to the bureaucratic policymaking? If so, by what mechanism(s)?

---

# Does the institution generate grassroots contestation of powerful interst or astroturf legitimation of them? 
