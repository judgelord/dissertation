...
## If groups build the power to pass a Green New Deal, what happens when agencies write the actual policies? 
...
#### 2. Leverage resources into an impression of public support (Skocpol & Hertel-Fernandez)
...
# Does the institution enable grassroots contestation of powerful intersts or astroturf legitimation of them? 
...
More "conflict expansion" than groups with the most resources "buying" the impression of public support $\longrightarrow$ More "grassroots" than "astroturf"
...
Unified Agenda + ORIA reports + Regulations.gov (Rdata, SQLite):

[GitHub.com/JudgeLord/Rulemaking](https://github.com/judgelord/rulemaking)

or

[JudgeLord@Wisc.edu](mailto:JudgeLord@Wisc.edu)
...
![](../Figs/comments-form.pdf)
---

Influence on draft rules not mentioning "Environmental Justice"
