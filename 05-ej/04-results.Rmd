...
```{r ej-m-PR-comments-agencyFE, fig.cap = "Probability Environmental Justice is Added Between Draft and Final Rules by Number of Comments", out.width = "80%", fig.show = "hold", fig.subcap=""}
