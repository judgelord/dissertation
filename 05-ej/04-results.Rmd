...
Figure \@ref(fig:ej-m-PR-shareI) shows the predicted probability of EJ being added to rules at different overall rates of addressing EJ in final rules ("Agency EJ Ratio" in Model 1). With a baseline rate of 67%, the EPA has the highest baseline rate of addressing EJ and also the greatest predicted responsiveness to EJ comments on proposed rules where EPA did not address EJ. At the average baseline ratio of 27%, the Federal Highway Administration (FHWA) has a smaller predicted increase when commenters raise EJ concerns. The Commodity Credit Corporation (CCC) and Federal Aviation Administration rarely address EJ in their final rules and have lower levels of responsiveness to EJ comments.^[Appendix Figure \@ref(fig:ej-m-PR-agency-top) offers an alternative approach, estimating individual agency effects, where possible.] The strong correlation between a tendency to address EJ and responsiveness to comments raising EJ concerns is strong evidence for the *Policy Receptivity Hypothesis* (\@ref(hyp:ej-receptivity)).
