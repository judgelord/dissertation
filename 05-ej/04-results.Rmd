...
As logit coefficients are not easily interpretable, Figures \@ref(fig:ej-m-PR-president-median-1), \@ref(fig:ej-m-PR-comments), and  \@ref(fig:ej-m-PR-agency-top) show the predicted probability of a final rule addressing environmental justice when the draft rule did not. 
