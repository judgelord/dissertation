...
```{r ej-mejPR-ejcomments-agencyFE, fig.cap = "Probability Environmental Justice is Added Between Draft and Final Rules by Number of Comments Raising Environmental Justice", out.width = "80%", fig.show = "hold", fig.subcap=""}

knitr::include_graphics(here::here("figs", "ej-mejPR-ejcomments-agencyFE-1.png"))

```

Figure \@ref(fig:ej-mejPR-comments-agencyFE) shows the probability that an agency will change EJ language given different total numbers of comments. 
