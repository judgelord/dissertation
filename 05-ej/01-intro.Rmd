...
Scholars have also shown the effect of specific pressure tactics. For example, protests affect policy [@Gillion2013]. Petition campaigns can build the organizational capacity to affect policy [@Carpenter2020]. Activists reshape political parties to enact new policy agendas [@Schattschneider1942; @Cohen2008, @Schlozman2015, @Skocpol2016].
