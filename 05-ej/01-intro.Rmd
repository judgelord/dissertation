...
Chapter \@ref(whymail) and Chapter \@ref(influence) focus on majoritarian reasons that public pressure may affect policymakers (e.g., through impressions about the scale of public support or the involvement of a member of Congress). Here, I focus on an additional type of political information: claims about policy-relevant communities and their deservingness of governmental attention. Doing so focuses on how public pressure campaigns may also advance minority rights. Moreover, where Chapter \@ref(whymail) and Chapter \@ref(influence) focus on the impact of isolated pressure campaigns, this chapter looks across many campaigns with similar demands to assess the aggregate effects of a broader movement.
...
While scholars often *compare* the participation of groups to individual citizens (see @Yackee2019 for a review), "it can be difficult to distinguish an individual's independent contribution from an interest-group-generated form letter" [@Seifter2016UCLA, pg. 1313]. As [@Rossi1997, p. 194] argues, "individuals are most likely to participate in agency decisions
by virtue of their membership in interest groups." Indeed, Chapter \@ref(whymail) shows that nearly all individual comments on proposed policies are mobilized by interest groups. <!--Researchers should view the participation of individuals as a direct result of interest group mobilization and can ignore the small number of unaffiliated individuals. <!--Indeed, efforts to broaden citizen participation that seek *unmediated* participation are likely infeasible.--> 
