...
existing theory and empirical scholarship suggest skepticism that public pressure campaigns matter. For example, @Balla2018 find that  "legal imperatives trump political considerations" (p. 1). (See Sections \@ref(why-mass) and \@ref(influence-mass) for reviews of scholarship on mass comment campaigns and their impact on policy.) 
...
As discussed in Section \@ref(why-theory), @Nelson2012
...
As theorized in Section \@ref(influence-theory), the number of supporters may
...
by virtue of their membership in interest groups." Indeed, as I demonstrated in Section \@ref(why-results), nearly all individual comments on proposed policies are mobilized by interest groups. Researchers should view the participation of individuals as a direct result of interest group mobilization and can ignore the small number of unaffiliated individuals. <!--Indeed, efforts to broaden citizen participation that seek *unmediated* participation are likely infeasible.--> 
