...
In contrast to scholarship on social movements, policy-focused environmental justice scholarship focuses more on the effects of policy than the inputs to the policy process. For example, @Bullock2018 investigate whether EJ policies affect exposure to pollution, @Liang2016 finds that EJ policies are not always effective, and @Liang2017 find that states with more lax immigration laws also have more lax monitoring of regulatory compliance in Latinx neighborhoods. @Pellow2016 dubs work documenting unequal outcomes the "first generation" of EJ scholarship, with a "second generation" of EJ scholarship now incorporating insights from critical race theory and social movement scholars, developing critiques and studies of movements through the lens of critical theory.

Empirical environmental justice studies that look at both the inputs and outputs of the policy process are rare and have thus far focused more on inequalities in geographies or enforcement than policymaking processes. @Abel2015 find that states that are poorer and less White have more developed EJ policies. Particularly relevant to the present analysis, @Konisky2017 find that regulatory enforcement is correlated with political mobilization around EJ issues. <!--MORE TOTODO-->
