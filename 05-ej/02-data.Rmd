...
```{r ej-data, fig.cap = "Proposed and Final Rules by Whether they Address Environmental Justice.", out.height = NULL, out.width = "99%", fig.show = "hold"}
...
knitr::include_graphics(here::here("Figs", "race-prob.png"))
```
...
<!--
Examples in previous sections illustrate how sentences mentioning "environmental justice" might be added or change. As an example of how comments may not change
-->
