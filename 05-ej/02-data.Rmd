...
Figure \@ref(fig:ej-pairs) shows the draft and final rule pairs used in each measure---measure 1 leveraging variation in final rules where the draft contained no mention of EJ and measure 2 leveraging variation in the text addressing EJ when the draft did address EJ. 
