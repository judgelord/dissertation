...
and investigate whom these groups represent. I then use a hand-coded sample of 10,000 organizational comments on a random sample of 200 rules to assess which types of organizations get the substantive policy changes they request when raising EJ concerns.
