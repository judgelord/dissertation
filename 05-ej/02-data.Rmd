...
protection from them when they are contaminated. By focusing on distributions of costs and benefits, fights over EJ analyses differ from the more utilitarian or preservationist analyses that dominate White environmental activism and policymaking [@Harrison2019].
...
Because the EJ demands often oppose the status quo, this aligns with the findings of Chapter \@ref(influence) that advocating for the status quo is one of the strongest predictors of lobbying success (also see @Baumbartner2009).  
