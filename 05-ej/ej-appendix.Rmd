...
predicted <- predictions(m_PR_agencyFE_ejcomment,
                newdata = values) %>% 
  #FIXME 
...
coord_flip() +
  ...
  scale_y_continuous(breaks = c(0, .5,1)) +
  theme(panel.grid.major.y = element_blank(),
        panel.border = element_blank()) + ylim(0,1)
```
