...
- [ x ] Transform ej_comments to reduce colinearity with ej_comment ()

- [ x ] Dedupe PRs and FRs, or at least explore sensitivity to which of multiple PRs is used. Perhaps select on `comments` then `posted_date`? The PR with the most comments is most likely the main PR, but many have 0 comments. However, date is complicated. A later PR could be an extension of the comment period. A later FR could be a small amendment. New metadata may help with this. 
