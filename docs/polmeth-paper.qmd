...
author:
  - name: "Devin Judge-Lord"
    thanks: "I am grateful for comments from attendees at PolMeth 2022 on an earlier [poster-version](https://judgelord.github.io/research/iterative/) of this paper. Support for this project includes the APSA DDRIG (NSF Grant #2000500). The most recent draft is available at [judgelord.github.io/research/iterative](https://judgelord.github.io/dissertation/polmeth-paper.pdf)"
    affiliations:  
    ...
    attributes:
      corresponding: true
thanks: |
    I am grateful for comments from attendees at PolMeth 2022 on an earlier [poster-version](https://judgelord.github.io/research/iterative/) of this paper. Support for this project includes the APSA DDRIG (NSF Grant #2000500). The most recent draft is available at [judgelord.github.io/research/iterative](https://judgelord.github.io/dissertation/polmeth-paper.pdf)
...
```{r fig-spatial-coding, fig.cap= "Coding the Spatial Position of Comments on Proposed Policy Changes"}
...
#| tbl-cap: "A Sample of Hand-coded Data Summarized by Coalition"
...
```{r tbl-coalition-types"}
#| label: tbl-coalition-types
#| tbl-cap: "Types of Lobbying Coalitions in the Hand-coded Sample"
