...
title: "Public Pressure and Congressional Oversight"
subtitle: "Evidence from Agency Rulemaking"
author: "Devin Judge-Lord <br>  Harvard University"
date: "Paper, slides, & data: [judgelord.github.io/research/oversight](https://judgelord.github.io/research/oversight)"
urlcolor: cyan
output:
...
knitr::include_graphics(here::here("Figs", "FWS-HQ-ES-2018-0006-53372-press.png"))
```
...
```{r, out.width = "70%"}
knitr::include_graphics(here::here("examples/congress/EPA-HQ-OAR-2005-0161-2624.png"))
...
knitr::include_graphics(here::here("Figs/sierra1.jpeg"))
...
knitr::include_graphics(here::here("examples/congress/CFPB-2016-0025-148844.png")  )
```
...
```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics(here::here("examples/congress/CFPB-2016-0025-148844-constituent.png")  )
```
...
```{r, out.width = "100%", fig.cap=""}
knitr::include_graphics(here::here("examples/congress/CFPB-2016-0025-148844-astroturf.png")  )
```
...
### Text-reuse + hand-coding identify coalitions of groups and legislators
...
knitr::include_graphics(here("Figs", "coded-support-1.png"))
```
...
knitr::include_graphics(here("Figs", "data-congress-1.png"))
```
...
knitr::include_graphics(here::here("Figs/congress-corr-2.png"))
```
...
knitr::include_graphics(here::here("Figs/model-oversight-1.png"))
```
...
knitr::include_graphics(here::here("Figs/mo-success-did.png"))
```
...
- While this often makes legislators on the same side as corporations, controlling for a policy position, legislators are slightly more likely to support public interest coalitions
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/BSEE-2017-0008-0473.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/TREAS-DO-2007-0015-0112.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/TREAS-DO-2007-0015-0125.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/OCC-2020-0026-0002.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/OCC-2020-0026-0277.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/FWS-R9-ES-2008-0093-8782.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/IRS-2016-0015-0134.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/EPA-HQ-OAR-2013-0495-11019.png"))
```

---

```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/EPA-HQ-OAR-2013-0495-11019 source.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/CFPB-2019-0006-39935.png"))

knitr::include_graphics(here::here("examples/congress/CFPB-2019-0006-0344.png"))
```
...
```{r, out.width = "50%"}
knitr::include_graphics(here::here("examples/congress/whiteboard.png"))
```
...
```{r, out.width = "100%"}
knitr::include_graphics(here::here("examples/congress/IRS-2019-0039-8319.png"))
```
