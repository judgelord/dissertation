...
Most scholars are not looking at policy with a few notable exceptions (like Dan Gillion and Omar Wasow's work on civil rights protests, Jamila Michener). When they do, they usually focus on a few pieces of landmark legislation.
...
Information is how policymakers change their minds, especially experts and lawyers.
...
✅ : "Opportunity struture" (Marks & McAdam 2007; McAdam 2010) "fit inside the legal narrative" (Scott 1998; Deloria 2009; Hilson 2002; Delaney 2017)   
...
winrates %>% 
  ...
  dplyr::select(-`N raising EJ`) %>% mutate(across(where(is.numeric), pretty_num)  ) %>%
      knitr::kable(caption = "") %>% 
      kable_styling(font_size = 22, position = "center")  #kable3(caption = "Hand-coded Lobbying Success by Type of Organization, 2005-2020")
```
...
- Other discursive terms/movements? ("racial"/"low-income" etc.)
