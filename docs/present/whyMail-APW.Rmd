...
```{r causal-classic, fig.cap="A Simple Model of Interest-Group Lobbying", echo=FALSE}
...
```{r causal-whymail2, fig.cap = "Direct Effects of Political Information: Incorporating Political Information into Models of Bureaucratic Policymaking", echo=FALSE}
...
--
(more "grassroots" than "astroturf")
--
