...
I describe a suite of **exact methods** that can increase the power of common hand-coding tasks. Human coding can both inform and be aided by rule-based information extraction---iteratively structuring queries on unstructured text.
