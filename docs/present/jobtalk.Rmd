...
### (1) Logit: $Y_i = \beta_{1:n} X_{i} + \delta_p + \epsilon_{ip}$
...
$\delta_p$: president fixed effect   
$\epsilon_{ip}$: cluster-robust errors by president

---

### (2) Logit:  $Y_i = \beta_{1:n} X_{i} + \gamma_k + \delta_p + \epsilon_{ipk}$
...
knitr::include_graphics(here::here("Figs", "spatial-coding-1.png"))
```
