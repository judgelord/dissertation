...
# Does public pressure affect <mark>bureaucratic</mark> policymaking? 
--
  If so, by what mechanisms?
...
- H1: Policymakers address distributive justice when pressured

- H2: $\uparrow$ Coalition size (number of groups) $\rightarrow$  $\uparrow$ Policy response

- H3: $\uparrow$ Public attention (number of comments) $\rightarrow$ $\uparrow$ Policy response
...
# Modeling the probablity of policy change
...
.pull-left[
 $\checkmark$ Environmental Justice Claims + heterogeneous effects
 ]
...
class: right
 ...
 .pull-left[  $\checkmark$  Environmental Justice Claims + heterogeneous effects 
 ]
...
---
 ...
 $\checkmark$ Environmental justice demands + heterogeneous effects 
 ]
...
$\checkmark$     Public attention (absent specific pressure)
...
| ------------------------------------------ | :--: | 
| Environmental Justice Claims     | $\checkmark$   | 
