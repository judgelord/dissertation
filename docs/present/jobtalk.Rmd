...
The book covers everything from how groups mobilizie people and elected officials, to assessing the substantive policy influence of public pressure campaigns, and then even to assessing the effects of public pressure on judicial review. 
...
Specifically, I'm going assess the aggregate effects of many linked campaigns on the discourse and issue frames in the policy process---that is, how a movement affects policymakingacross institutions and over time.

But before I talk about environmental justice, I first want to start with two broader observations about our democracy that motivatate my work
...
# Public participation *is mobilized*

???

When we think about people being mobilized, the image that comes to mind is something like a protest or a march, but Today, instead of standing up at a public meeting, or attending a protest, most public engagment with policymakers increasingly takes place online
...
Most people engage in policymaking when targeted online by a group like the sierra club, which is one of the largest groups in the US environmental movment. 
...
class: inverse center middle
background-image: url(Figs/sierra.jpeg)
background-size: contain


???

Here, we have the modal way that people engage with policymakers---submitting a letter drafted by a large national advocacy group.
...
```{r, agencies, out.width = "20%", fig.show="hold"}
knitr::include_graphics("Figs/epa-hq.jpeg")
knitr::include_graphics("Figs/dot-hq.jpeg")
knitr::include_graphics("Figs/usda-hq.jpeg")
knitr::include_graphics("Figs/fcc-hq.jpeg")
```
...
And this is true EVEN WHEN CONGRESS DOES LEGISLATE.

For years, I have presenting this work and posing the question, if Congress Passes GND is passed, 

---

If groups build the power to pass a Green New Deal, 
...
If groups build the power to pass ~~a Green New Deal~~  Build Back Better, 

what happens when 30+ agencies write the actual policies? 

---

If groups build the power to pass ~~a Green New Deal~~  ~~Build Back Better~~ Inflation Reduction Act, 

what happens when 33 agencies write the actual policies? 

???
Or NOW THAT climate groups have pushed through landmark climate policy in the Inflation Reduction Act THAT DOES in fact task 33 agencies with writing rules about how exactly the money will be spent and new regulations. 

Consider that the Biden Administration has pledged to spend 40% of climate and energy spending, including the IRA and bipartisan infrastructure bill in disadvantaged and EJ communities. Those funding criteria are being developed through agency rulemaking. 
...
- Policy demands and lobbying success for 40 million public comments to 40 agencies
...
- $\uparrow$ pressure  $\rightsquigarrow$ 	$\uparrow$ change in policy texts
...
--
- Policy rarely addresses distributive justice
???
...
--
- Climate and environmental justice frames affect cost-benefit analysis

---

## Policymakers rarely addresses distributive justice, but are more likely to when pressured, especially **receptive policymakers** who have **not already taken a position**.
