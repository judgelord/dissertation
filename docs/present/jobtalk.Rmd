...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      slideNumberFormat: "%current%/30"           # 12/42 
editor_options: 
...
???
Broader project here is part of a recent movement to bring back some of EE SchttschNeider's isights about politics as organized conflict over plicy. 
...
But to ground my larger quantative analysis, I want to start with an example of regulations on Mercury pollution. 
...
If you or your partner has been pregnant, you know that you need really careful about fish because mercury pollution accumulates in fish and is really harmful to brain development in fetuses and young kids. 
...
So, how did policymakers responded to mercury pollution? 
...
???
EPA had to then merely had to fill in little details like questions like who is the public and what is health, what is appripate and necessary? 
...
When an agency does this they most go through a process called rulemaking
...
Adovates like Heather were argued that mercury standards that protected the average person in the US did not protect certian minority communites, in this case many native communities who traditionally ate a lot more fish. 
...
and there is a large Hmong population that came over after the vietnam war, and other commenters raised produced studies that certain southeast asian immigrant populations like the Hmong also ate a lot of freshwater fish and thus had higher rates of Mercury poisning. Similarly the Ojibwe peoples in the great lakes region were had higher rates of mercury poising. 

So after all of this pressure the Bush EPA made changes. [SLIDE]

The Final Rule included a new section on the unequal impacts of mercury pollution. Even half of the cost benefit analysis now talked about how costs of mercury pollution were unequally distributied. This goal of enivonmenal justice was the justification for imposing social costs of power plant regulation. 

And when the Obama EPA returned to the tooic of mercury pollition, they received half a million comments, many raising environmental justice concerns 
...
# Does public pressure affect bureaucracy policymaking?
...
Puzzel: Does public pressure work on specific policies?
...
All our theories tell us that this probably not occure, and if it does occure it should not matter. 
...
So now that I have persuaded you that studying the politics of bureacratic policymaking is massively important and interesting, I'm puttting a roadmap for the rest of the talk on the top of my slides. I'll talk a bit about what we know and what existing theory tells us to expect. 
Then I'll reveiw the novel data and methods I am brining to this question
...
- Change in 13,000 draft and final rule pairs from 40 agencies, 1993-2020
- 40 million public comments 
 - Hand-coding $\Longleftrightarrow$ computational text analysis

???
13k policy pairs, for example the draft and final verion of the mercury rule

I used a combination of quantitative and qualitative text analysis to analyze 40 million public comments. Nearly all public comments received on thousands of draft policies by 40 agencies that make policy related to  environmental justice. The larger project looks at 161 agencies, but here I focus on agencies that make environmental policy---or more precisely agencies that make policy that is occasionally framed environmental policy.
...
- When activists raise concerns, policy texts change 
...
It matters whether policymakers adopt these issue frames because redefining problems can change policymakers calculations, both political and economic. For example, if you make policy about climate change, a whole avelange of new costs and benefits enter the equasion. 
...
Issue frames affect cost-benefit analysis
...
The second caveat is that these results are driven by historically-White national advocacy organizations advocacy organizations, not tribes or local “frontline” local groups in those "environmental justice communities” that the Biden administration is referencing with the justice 40 initiative
...
# Build Back Better, what happens when 30+ agencies write the actual policies? 
...
For example, consider that the Biden Administration has pledged to spend 40% of climate and energy spending, including billions of dollars from IRA and bipartisan infrastructure bill in disadvantaged and EJ communities. Those funding criteria that determine who is eligible are being developed through agency rulemaking. 
...
# The Evironmental Justice Frame

???

What is environmental justice and why is the Biden administration requiring 40% of federal spending to be spent in environmenal justice communities? 
...
- Emerged in local campaigns against toxic waste sites and pollution
...
background-image: url(Figs/DorcetaTaylor.jpeg)
background-size: contain
class: inverse
...
Dorceta Taylor describes how black-led campaigns like Johnson's fused with the American Indian Movement, Chicano, and farmworker movements and drew on the civil rights and union organizing to push the Evironmental justice frame onto the national policy agenda 
...
???
- We don't know a lot about policy outcomes, but there is some great work showing specific policy effects of civil rights protests, for example. Dan Gillion, LaGina Gause, and Omar Wasow
...
### Scholars focus on the power of *technical* information
...
### My DV: Systematic impact on specific policies (**agency rules**)

???
I am trying to add to recent work on policy impact of movements and pressure campaings by looking systematically at change in very specific policy documents

Whether executive branch agencies are implementing recent legislation or using authorty of centry-old statutes,  Rulemaking is where the teeth of federal law are forged and reforged over time.

So, I'm interested in the extent to which movements can affect agency rulemaking.

???

Aggregate impact of environmental justice campaigns across institutions and over time $\rightsquigarrow$ environmental justice movement impact
...
- ## Human coding and computational text analysis are more powerful when combined

???

If you remember one thing about the methods here it is that Human coding and computational text analysis are more powerful when combined, and I have several ways of doing that. 

First, I use something like plagirizm detetction to identify linked sets of documents that indicated that groups of commenters are in a lobbying coalition
...
Elsewhere, I used these same methods to assess the change between draft and final rule, and there are tutrials for how to do this on my website. 
...
## Iteratively group documents into coalitions
...
-  Lobbying success for all commenters on 150 rules, 2005-2020
 - 10,894 hand-coded documents representing over 40 million comments 
 - 284 coalitions 
...
Pr(Policy Change | President + Agency) ~ Policy Demands  \+  Coalition Size  \+  Public Pressure Campaign
...
```{r ej-m-PR-president-median-1, out.width = "90%"} 
...
```{r ej-m-PR-shareI, fig.cap = "", out.width = "90%", fig.show = "hold", fig.subcap=""}
...
```{r attention, out.width = "90%", fig.show = "hold"}
...
winrates %>% 
  ...
  mutate(`Organization Type` = `Organization Type` %>% str_replace("Environmental Group", "NGO-Environmental") %>% str_replace("Frontline EJ", "NGO-Local EJ")) %>% 
...
Larger coalitions and more public attention $\rightsquigarrow$ agencies are more likely  📈 to **add** EJ language
...
### Policymakers rarely address  environmental justice
--
...
Chapters of the book cover everything from how groups mobilizie people and elected officials, to assessing the substantive policy influence of public pressure campaigns, and then even to assessing the effects of public pressure on judicial review---whether courts uphold or strike down policies. 
...
Here a man stands up and voices his opinion at a public meeting. From is dress, we are told that he working class, not elite, and yet he is heard. 
...
To be acurate today. Rockwell would need to paint this man and his allies in matching teshirts reading from the script provided by the mobilizing organization. 
...
Clicking on "Take action" button it takes you to a website were you can submit a comment on the draft regulations. 
...
And here the Sierra Club is using the same graphic to mobilize people to write to the Trump administration asking it not to revserse the Obama-era regulations. 


And the internet makes it much easier to mobilze large numbers of people to engage in specific policy processes. You can on proposed policies from your phone.
...
But our institutions for incorporating public input on proposed policies are not built for this digital massi mobilzing. At the end, I'll return to what my research says about how we can make government more responsive in the age of digtial campaigns. 



NOW,  THE FACT that the sierra club is targeting the Environmental Potection Agency, leads me to the second observation about modern American Politics, which comes from a completely different literature.
...
Political opportunity my not just be about access to policymakers but also in terms of political receptivity to the claims being made." (Hilson 2002, p. 242)
