...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      slideNumberFormat: "%current%/31"           # 12/42 
editor_options: 
...
- [Data:](#data) Change in 13,000 draft and final rule pairs $\Longleftarrow$ 40 million public comments
--
...
- Who is affected? [(Lowi 1972, Woodly 2015)]()

- Coalition size? [(Nelson & Yackee 2012, Dwidar 2021)]()
...
- H2: $\uparrow$ Coalition size $\rightarrow$  $\uparrow$ Policy response

- H3: $\uparrow$ Public attention $\rightarrow$ $\uparrow$ Policy response

--

+ Heterogeneous effects: organization and institution
...
```{r ej-m-PR-president1, out.width = "50%"}
...
```{r ej-m-PR-president-median-1, out.width = "44%"} 
...
```{r ej-m-PR-shareI1, fig.cap = "", out.width = "44%", fig.show = "hold", fig.subcap=""}
...
```{r ej-m-PR-shareI2, fig.cap = "", out.width = "44%", fig.show = "hold", fig.subcap=""}
