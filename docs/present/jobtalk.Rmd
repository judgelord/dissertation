...
AND the Environmetntal Protection Agency (the EPA) Clinton and GW Bush administrations 
...
For example, Heather McCausland of the Alaska Community Action on Toxic wrote
...
#If groups build the power to pass a    
# Green New Deal, 

#what happens when 30+ agencies write the actual policies? 
...
#If groups build the power to pass   
#~~a Green New Deal~~    
#Build Back Better, 
...
#what happens when 33 agencies write the actual policies? 
...
- Lobbying success for 40 million public comments 
...
???
I am trying to add to recent work on policy impact of movements and pressure campaings by looking systematically at change in very specific policy documents---executive branch agency rules, which now make up 90% of US law; 
...
# Methods: Human coding and computational text analysis are more powerful when combined

---

<!--## Collapsing form letters with text reuse-->

Identifying linked documents

```{r percent-method, fig.show = "hold", out.width = "45%"}
...
## To sum up: large framing effects, but only large national advoacy groups have substantive policy influence 
...
HOWEVER, groups raising  environmental justice are usually "big green" (White) advocacy organizations.  
--

- Big greens are much more likely to have their substantive policy demands met
