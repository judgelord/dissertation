...
If we want to undstand modern democracy 

DEFINE ENVIRONMETNAL JUSTICE


part of a large project looking at policymaking across nearly all federal agencies

I am especially interested in environmental policy, where all of the fights have occured in agencies for my entire life 
...
Most policy is made in the executive branch 
don't have roll call votes - so I need to collect a big new data 
...
but if we want to understand democracy 
