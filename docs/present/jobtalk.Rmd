...
Lobbying success for all commenters (random sample of 150 rules $\Rightarrow$ 10,894 hand-coded comments) 
- 
...
([Table](#mediation-table), [Cross-sectional version](#success))
]
...
([Table](#coalition-success-table), [DiD version](#ej-org-success))
...
# Appendix Slides 
1. Data:  [Hand-coded comments](#datasheet) - [GIS](#gis) - [Census race](#race) - [Zip code](#gis)
2. [Methods](#methods) 
1. Mobilizing - [Organizations](#orgs) - [Mass comments](#mass) <!-- Grassroots - Astroturf--> - [members of Congress](#coalition-legislators)
1.  Framing
  1. EJ: [Mercury rules](#ej-mercury) - Rules [by president](#ej-data-rules) - [by Agency](#ej-data-agencies) - [Data](#ej-data) - [Theory](#ej-hyp) - [Alt Results](#ej-results) - [Tables](#table)
  2. Climate Change - [Data](#cj-data) - [Results](#cj-results) - [Tables](#cj-table)
1. Influence [by campaign type](#success-coalition) - [by legislator support](#coalition-legislators)
1. [Judicial review](https://judgelord.github.io/research/deference/)
