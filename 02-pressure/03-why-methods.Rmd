...
rules (over 16,000 proposed rules from 144 agencies from 2005 to 2020). Of these, public pressure campaigns targed approximately 400 rules from 46 agencies.
...
Comments with identical text (if any) indicate a coordinated campaign. Through and itterative process of hand coding and computational methods, I then identify the organization responsible for mobilizing each comment and group organizations into coalitions. 
...
#### Identifying coalitions using text re-use and clustering methods
...
> TODO: INSERT AND DESCRIBE FIGURE SHOWNING A COALITION IDENTFIED THROUGH TEXT REUSE
