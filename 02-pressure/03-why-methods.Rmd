...
Membership organizations exist to serve their members interests. Unions frequently lobbying rulemaking.
...
The primariy unit of analiysis is the a coalition--a group of organizations advocating for the same policy changes in their comments on a draft rule. 
...
Classifying coalitions as primarily driven by private or public interest provides analytic leverage, but scholars have not converged on a approach to do so. @Potter2017 distinguishes "advocacy groups" from
...
<!-- TODO: AN IMPORTANT NOTE BUT NOT SURE WHERE TO PUT IT: 
...
[@Schattschneider1975]. Public pressure campaigns are no exception, and mobilizing organizations almost always evoke some version of the public interest. Classifying thus involves judement calls. 
-->
