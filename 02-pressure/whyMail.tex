...
% title, author, date
  ...
  \author{ % author, option footnote, optional affiliation
            Devin Judge-Lord\footnote{University of Wisconsin-Madison, \href{mailto:judgelord@wisc.edu}{\nolinkurl{judgelord@wisc.edu}}. Presentation Slides and the most recent draft are available at \url{https://judgelord.github.io/research/whymail}} 
            }
...
% \pagenumbering{gobble}
  ...
  \begin{abstract}
    \noindent THIS DRAFT WAS PREPARED FOR THE 2020 AMERICAN POLITICAL ECONOMY WORKSHOP. PRESENTATION SLIDES AND THE MOST RECENT DRAFT ARE \href{https://judgelord.github.io/research/whymail/}{HERE}
...
\textbf{Note to reader:} Thank you so reading this draft. For context, this dissertation chapter develops concepts and measures of public engagement in rulemaking that I apply in chapters 3 and 4. The methods are under construction, and the empirical claims are tentative.
...
\textbf{Chapter 1 situates agency rulemaking in the context of American poliitcs.} I show that rulemaking is a major site of policymaking and political conflict.
...
I find that public interst campiagns explain variation in mass engagement. That is, unlike other forms of lobbying, it is not primarily driven by interests with the large finanical stakes and resources.
...
\textbf{Chapter 6} concludes with remarks for scholars on the study of bureaucratic policymaking and policy recomendations to better account for the fact that public pressure campains and the bursts of civic engagment they mobilize will be an enduring feature of the policy process.
...
balance interest-group demands.\footnote{
  On learning, see \citet{Kerwin2011} and empirical studies by \citet{yackee2012},
  \citet{Cook2017}, \citep{Gordon2018}, and \citet{Walters2019}. See \citet{Gailmard2017} and
  \citet{Libgober2018} for information-based models where comments reveal
  information to the agency.
  On accountability to elected officials, see \citet{Furlong1997}, \citet{Nou2016},
  \citet{Potter2016}, \citet{Woods2018}, and \citet{Yackee2009RegGov}. See \citep{Gailmard2012}
  ...
  \citet{Potter2014dis} develops a signaling model where agencies propose and
...
Foundational scholarship on rulemaking by \citet{Furlong2005}, \citeauthor{Furlong1997} \citetext{\citeyear{Furlong1997}; \citealp{Furlong1998}}, and \citet{Kerwin2011} focuses on interest group lobbying. To
...
business interests
\citep{Seifter2016UCLA, Crow2015, Wagner2011, West2009, Yackee2006JOP, Yackee2006JPART, Golden1998, Haeder2015, Cook2017}.
...
the public and may not represent them well \citep{Seifter2016UCLA}. Scholars
...
\begin{quote}
``\citet{Kerwin2011} point out that a citizen must know not only that a
...
expertise. As \citet{Epstein2014} suggest, agency rule-writers--who are often
...
effort.\footnote{Following the conventional terms ``mass comment campaign'' and
...
(see Figure @ref(fig:comments\_per\_rule); note that comments per rule are on a
...
rulemaking \citep{Coglianese2001}, but this intuition has yet to be tested.
...
actual American governance'' \citep{Herz2016}. \citet{Rossi1997} finds that ``courts,
...
\begin{figure}
\hypertarget{fig:regs.gov}{%
\centering
\includegraphics[width=6.5in,height=\textheight]{../Figs/regulations-header.png}
\caption{Regulations.gov Solicits Public Comments on Draft Agency Rules}\label{fig:regs.gov}
}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=6.5in,height=\textheight]{../Figs/comments-mass-vs-unique-1.png}
\caption{Comments on Proposed Rules per Year (\#fig:comments\_per\_year)}
\end{figure}

\begin{figure}
\hypertarget{fig:comments_per_rule}{%
\centering
\includegraphics[width=4.5in,height=\textheight]{../Figs/rules-comments-per-year-1.png}
\caption{Comments per Rule}\label{fig:comments_per_rule}
}
\end{figure}
...
@ref(fig:comments\_per\_year) shows, every year since 2008, most people who
comment on draft regulations have done so as a result of an interest
group's campaign.\footnote{At least for agencies participating in regulations.gov. See
  sections
...
policymaking.\footnote{If defining ``political participation'' as ``acts aimed at
  influencing governmental decisions \citep[ p.~2]{Verba1987}, signing a
...
of the broader public \citep{Verba1987}, but in many ways, they must be more
representative than the handful of political insiders who participate in
most policy processes. As \citet{Schattschneider1942} put it, the usual
...
\ref{fig:causal-classic-lobbying}\label{fig:causal-classic-lobbying}\{reference-type=``ref''
...
scholarship on lobbying in bureaucratic policymaking to date.\footnote{Diamonds indicate observable choices, ovals indicate latent
  preferences, and rectangles indicate information.}
However, mass engagement has no place in this model. I aim to fill this
gap.

The `Classic Model' of Interest Group Lobbying in Bureaucratic Policymaking
...
as a tactic \citep{Furlong1997, Kerwin2011} have thus far focused on
...
can demonstrate some verifiable public support.\footnote{Public support can be faked or inflated using ``astroturf'' tactics
...
opinion'' that policymakers observe.\footnote{I address other types of political information that mass
...
lobbying when their opposition does so. While \citet{Potter2017} found industry
...
Mass mobilization campaign by the Sierra Club collects contact information
...
\caption{\label{tab:campaigns-patterns} Observable differences in engagement across types of
mass-mobilization campaigns}\tabularnewline
\toprule
\endhead
& Inside & & Outside &\tabularnewline
& Technical information & Number of comments & Effort & Contagion\tabularnewline
Going public & High & High & High & High\tabularnewline
Disrupting & High & Low & Low & Low\tabularnewline
Going down fighting & Low & High & High & High\tabularnewline
\bottomrule
\end{longtable}
...
\subsubsection{Types of public engagement}\label{types-of-public-engagement}}
...
\hypertarget{measuring-mass-engagement-and-political-information}{%
\subsubsection{Measuring mass engagement and political information}\label{measuring-mass-engagement-and-political-information}}
...
\protect\hyperlink{fig:toporgs}{\[fig:toporgs\]} shows the top organizers of comments posted to
regulations.gov.

\includegraphics[width=6.5in,height=\textheight]{../Figs/toporgs.png}
\protect\hypertarget{fig:toporgs}{}{\[fig:toporgs\]}
...
\hypertarget{text-reuse-and-clustering.}{%
\paragraph{Text reuse and clustering.}\label{text-reuse-and-clustering.}}
...
possible pair of texts to identify matches. \footnote{For more about this method and comparisons with related partial
  matching methods such as the Smith-Waterman algorithm, see
  \citet{Casas2017} and \citet{Judge-Lord2017}}.
...
\begin{figure}
\hypertarget{fig:kmeans}{%
\centering
\includegraphics[width=7in,height=\textheight]{../Figs/kmeans.png}
\caption{K-means clustering fails to capture coalitions when nearly all
comments oppose a
regulation{}}\label{fig:kmeans}
}
\end{figure}
...
variation. Figure \protect\hyperlink{fig:kmeans}{1} shows k-means clusters based on a normalized
...
\protect\hyperlink{fig:kmeans}{1}, models
...
\hypertarget{results-patterns-of-public-engagement-in-rulemaking}{%
\section{Results: Patterns of Public Engagement in Rulemaking}\label{results-patterns-of-public-engagement-in-rulemaking}}

\label{whyMail-results}

\hypertarget{patterns-of-public-engagement-in-rulemaking}{%
\subsubsection{Patterns of public engagement in rulemaking}\label{patterns-of-public-engagement-in-rulemaking}}
...
Figure
\protect\hyperlink{fig:comments-support}{\[fig:comments-support\]} shows all comments posted on
...
\protect\hyperlink{fig:comments-support}{\[fig:comments-support\]} shows mass commenting campaigns
mobilize the vast majority of comments. In other words, most comments
are from ordinary people.

\includegraphics[width=\textwidth,height=2in]{../Figs/comments-mass-1.png} \includegraphics[width=\textwidth,height=2in]{../Figs/comments-mass-support-vs-oppose-1.png}

\protect\hypertarget{fig:comments-support}{}{\[fig:comments-support\]}

The right pane of Figure
\protect\hyperlink{fig:comments-support}{\[fig:comments-support\]} shows results from a sample of several
...
\protect\hyperlink{fig:comments-support}{\[fig:comments-support\]}). This may be a function of the
...
\protect\hyperlink{fig:sentiment-2018}{\[fig:sentiment-2018\]} and
\protect\hyperlink{fig:sentiment-2016}{\[fig:sentiment-2016\]} in the appendix for a sample of comments
...
\protect\hyperlink{fig:topdockets}{\[fig:topdockets\]}.

\includegraphics[width=6in,height=\textheight]{../Figs/topdockets.png}
\protect\hypertarget{fig:topdockets}{}{\[fig:topdockets\]}
...
As Figure \protect\hyperlink{fig:topdockets}{\[fig:topdockets\]} shows, the most prolific mobilizers are
...
\protect\hyperlink{hyp:disrupt}{\[hyp:disrupt\]}.
...
The Role of Mass Commenting and Political Information in Bureaucratic Policymaking
