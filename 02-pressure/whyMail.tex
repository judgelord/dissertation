...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(here}\OperatorTok{::}\KeywordTok{here}\NormalTok{(}\StringTok{"Figs/sierra2.jpeg"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\textbf{Chapter 6} concludes with remarks on the study of bureaucratic policymaking and policy recomendations to better account for the fact that public pressure campains and the bursts of civic engagment they mobilize will be an enduring feature of the policy process.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(}\StringTok{"../Figs/regulations{-}header.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Regulations.gov Solicits Public Comments on Draft Agency Rules

\begin{figure}
\centering
\includegraphics{../Figs/regulations-header.png}
...
\caption{Comments on Proposed Rules per Year \label{fig:commentsperyear}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=4.5in,height=\textheight]{../Figs/rules-comments-per-year-1.png}
\caption{Comments per Rule\label{fig:commentsperrule}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{../present/classicmodel.png}
...
\begin{theorem}
\protect\hypertarget{thm:support}{}{\label{thm:support} }Lobbying coalitions
...
\begin{theorem}
\protect\hypertarget{thm:disrupt}{}{\label{thm:disrupt} }When a lobbying
...
\begin{figure}
\centering
\includegraphics{../Figs/sierra2.jpeg}
\caption{Mass mobilization campaign by the Sierra Club collects contact information \label{fig:sierra}}
\end{figure}
...
\toprule
& Inside lobbying & Outside lobbying &\tabularnewline
\midrule
\endfirsthead
\toprule
& Inside lobbying & Outside lobbying &\tabularnewline
\midrule
\endhead
``Normal'' lobbying & High & None &\tabularnewline
``Going public'' & High & High &\tabularnewline
``Disrupting consensus'' & High & Low &\tabularnewline
``Going down fighting'' & Low & High &\tabularnewline
\bottomrule
\end{longtable}
...
\begin{theorem}
\protect\hypertarget{thm:publicinterest}{}{\label{thm:publicinterest} }
...
\begin{figure}
\centering
\includegraphics{../present/model.png}
\caption{The Role of Mass Commenting and Political Information in Bureaucratic Policymaking (\#causal-full)}
\end{figure}
