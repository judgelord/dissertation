...
Hypothesis \@ref(hyp:meditated) posited that most people engage in the policy process due to organized public pressure campaigns. This is overwhelminingly true.  Figure
\@ref(fig:comments-mass) shows that every year since 2007, the vast majority of
comments on draft regulations posted to regulations.gov were a result of a public pressure campaign.
...
<!--concluding paragraph where you summaries how your results matched up with your hypotheses. -->
...
flavor of information. Because the nearly all public participation in agency rulemaking is mobilized as part of a public pressure campaign, levels of public participation reaveal information about levels of public support behind different lobbyign coalitions. 

<!--hyp:coalitions-->
The political information generated by public pressure campaigns is not a substitute for sophisticated with technical information; public pressure campaigns almost always explicitly support a more sophisticated lobbying effort. Not only do coalitions that sponsor pressure campaigns almost alwasy include sophisticated policy lobbying efforts, almost all of the organizations that mobilize the most public comments also pursue inside lobbying strategis. Indeed most of these organizations use pressure campaigns fairly rarely. 
