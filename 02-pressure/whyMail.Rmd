...
output:
   pdf_document:
      template: 'article-template.tex' # redirect to assets
      keep_tex: true
...
# GIT RID OF THIS 
#  includes:
#      in_header: "preamble.tex" # '`r here::here("preamble.tex")`'
# \input{preamble.tex}
# % \usepackage{figcaps}
...
**Note to reader:** Thank you so much for reading this draft. For context, this dissertation chapter develops concepts and measures of public engagement in agency rulemaking that will be used in chapters 3 and 4. The methods are under construction, and the few empirical claims are very tentative.
...
```{r child = here::here("02-pressure/intro-motivation.text")}
```
...
<!--% FULL CAUSAL
```{r child = here::here("tikz/causal-full.tex")}
```
-->
