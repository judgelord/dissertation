...
**Note to reader:** This dissertation chapter develops concepts and measures of public engagement in rulemaking that I apply in chapters 3 and 4. The methods are under construction, and the empirical claims are tentative.
...
knitr::include_graphics("../Figs/causal-full.png")
```

```{r comments-from, fig.cap="Sources of Comments Posted to regulations.gov"}
knitr::include_graphics("../Figs/comments-from.pdf")
```
