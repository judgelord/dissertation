...
The ability to mobilize a large number of people can thus be a valuable political resource.^[I use "mobilizing" rather than "organizing" because "organizing" often implies that people are organized in a way that is more enduring than signing a single petition or writing a single letter. Mobilizing implies an activation, but not necessarily enduring structure.] 
...
situations where an organization mobilizes for reasons other than influencing policy, like engaging or recruiting members. 
...
communication from the Sierra Club." While this campaign may have had little hope if influenceing these policies, it may have increased awarness of air pollution and built contact lists that could help the Sierra Club raise funds and mobilize in future policy fights.


```{r sierra, out.width="40%",fig.cap = "The Sierra Club Builds Contact Lists Through Public Pressure Campaigns"}
