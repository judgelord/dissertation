...
While political science theories often assume that membership organizations advocate on behalf of somewhat exclusive private interests, they also lobby for broader public preferences [@CITE]. For example, healthcare worker unions frequently lead policy campaigns focused on public health and even issues like climate change. The link between an organizations' policy agenda and the prefrences of its members is sometimes more plausable than others.
...
business coalitions. -->
<!-- need paragraph on dilliberative lit?-->
...
I argue that mass engagement produces potentially valuable political information about the coalition that mobilized it. To the extent that groups aim to influence policy, public pressure campaings support sophisticated lobbying. That is, public pressure should be studied as a potential compliment, not an alternative to sophisticated lobbying. This means that the role that public pressure may play in policymaking depends on who mobilized it and why. The first step in understanding the potential impact of public pressure is to develop testable theories about the drivers of public participation.  
...
Existing scholarship suggests two possible reasons why agencies may recieve millions of public comments. From a conflict expansion perspective, groups that are disadvantaged by the status quo out to utilize public pressure campaigns. Existing theories of lobbying the bureacracy suggest that well-resourced and concentrated interests will dominate. 
...
<!-- these two paragraphs are somewhat repeated elsewhere. also, need more theiry-->
