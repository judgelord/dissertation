...
The first step in the policy process the publication of a draft rule (`r draft`). The first broadly observable step in the rulemaking process is usually an agency publishing a draft rule in the Federal Register.^[As agency rulemaking is my empirical case of policymaking,  I use "rule" and "policy" interchangeably.]
...
knitr::include_graphics(here::here("Figs", "causal-classic.pdf"))
```
