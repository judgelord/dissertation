...
```{r beacon , echo=FALSE, results='asis', eval=FALSE }
...
Elected officials' engagement in agency rulemaking is positively affected by the scale of public engagement.
```
