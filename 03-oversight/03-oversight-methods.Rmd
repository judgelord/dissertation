...
variables of interest are the measures of mass engagement. For simplicity, in the
equations below, I only include measures related to the number of
comments. Thus $\beta_0$ is the estimate for a rule with either no public
comments or no supportive public comments.
