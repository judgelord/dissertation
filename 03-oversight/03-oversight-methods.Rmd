...
```{r congress, fig.cap = "Number of Letters from Members of Congress Received During Rulemaking per Year", out.width = "6.5in"}
...
```{r causal-oversight-1, fig.cap = "The Relationship Between Public Pressure and Congressional Oversight"}
